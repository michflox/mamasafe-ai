/**
 * Pure-TypeScript synchronous SHA-256. No Node crypto, no WebCrypto —
 * works identically in browser, worker, and Node so the audit chain is
 * portable and replayable everywhere. Standard FIPS 180-4 algorithm.
 */
